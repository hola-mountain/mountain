...
public class MountainHandler {
    ...
    public Mono<ServerResponse> getMountainList(ServerRequest serverRequest){
        ...
        Mono<MountainPageResp> mountainMono = mountainService.getMountainListPage(district, pageNum, pageSize, sortBy, isAsc, search);

        return ServerResponse.ok()
                .contentType(MediaType.APPLICATION_JSON)
                .body(mountainMono, MountainPageResp.class)
